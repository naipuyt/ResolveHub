    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard-masyarakat.php">
                ...
                <div class="sidebar-brand-text mx-3">ResolveHub</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link-dashboard" href="dashboard-masyarakat.php">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link-laporan" href="laporan.php">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-7 mb-4">
                            <div class="card-lapor border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-lapor text-xs font-weight-bold text-uppercase mb-1">
                                                Laporan Saya</div>
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-4 col-md-7 mb-4">
                            <div class="card-proses border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-4 col-md-7 mb-4">
                            <div class="card- seborder-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
